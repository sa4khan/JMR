...
#include "stanExports_ggammarizsimple.h"

RCPP_MODULE(stan_fit4ggammarizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ggammarizsimple")
