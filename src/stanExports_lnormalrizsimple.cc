...
#include "stanExports_lnormalrizsimple.h"

RCPP_MODULE(stan_fit4lnormalrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lnormalrizsimple")
