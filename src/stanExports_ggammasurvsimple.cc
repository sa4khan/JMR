...
#include "stanExports_ggammasurvsimple.h"

RCPP_MODULE(stan_fit4ggammasurvsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ggammasurvsimple")
