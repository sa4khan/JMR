...
namespace model_lnormalsurvrizsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lnormalsurvrizsimple");
    reader.add_event(43, 41, "end", "model_lnormalsurvrizsimple");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lnormalsurvrizsimple
  : public stan::model::model_base_crtp<model_lnormalsurvrizsimple> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_lnormalsurvrizsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lnormalsurvrizsimple_namespace::model_lnormalsurvrizsimple";
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(llik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            lognormal_ccdf_log(((stan::math::exp((-(get_base1(pred0, i, "pred0", 1)) - (get_base1(phi, i, "phi", 1) * (get_base1(xalpha_fixed, i, "xalpha_fixed", 1) + get_base1(get_base1(b, i, "b", 1), 1, "b", 2))))) * (1 - stan::math::exp(((-(get_base1(phi, i, "phi", 1)) * (get_base1(alphatime, i, "alphatime", 1) + get_base1(get_base1(b, i, "b", 1), 2, "b", 2))) * st)))) / (get_base1(phi, i, "phi", 1) * (get_base1(alphatime, i, "alphatime", 1) + get_base1(get_base1(b, i, "b", 1), 2, "b", 2)))), -(stan::math::log(get_base1(rho, i, "rho", 1))), (1 / get_base1(kappa, i, "kappa", 1))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lnormalsurvrizsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_lnormalsurvrizsimple";
    }
...
typedef model_lnormalsurvrizsimple_namespace::model_lnormalsurvrizsimple stan_model;
#ifndef USING_R
