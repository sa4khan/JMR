...
#include "stanExports_llogisticrizsimple.h"

RCPP_MODULE(stan_fit4llogisticrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_llogisticrizsimple")
