...
#include "stanExports_weibullrizsimple.h"

RCPP_MODULE(stan_fit4weibullrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_weibullrizsimple")
