...
namespace model_llogisticsurvrizsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_llogisticsurvrizsimple");
    reader.add_event(42, 40, "end", "model_llogisticsurvrizsimple");
    return reader;
}
#include <stan_meta_header.hpp>
class model_llogisticsurvrizsimple
  : public stan::model::model_base_crtp<model_llogisticsurvrizsimple> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_llogisticsurvrizsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_llogisticsurvrizsimple_namespace::model_llogisticsurvrizsimple";
        ...
        try {
            ...
            validate_non_negative_index("xalpha_fixed", "N", N);
            context__.validate_dims("data initialization", "xalpha_fixed", "vector_d", context__.to_vec(N));
            xalpha_fixed = Eigen::Matrix<double, Eigen::Dynamic, 1>(N);
            vals_r__ = context__.vals_r("xalpha_fixed");
            pos__ = 0;
            size_t xalpha_fixed_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < xalpha_fixed_j_1_max__; ++j_1__) {
                xalpha_fixed(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 12;
            validate_non_negative_index("alphatime", "N", N);
            context__.validate_dims("data initialization", "alphatime", "vector_d", context__.to_vec(N));
            alphatime = Eigen::Matrix<double, Eigen::Dynamic, 1>(N);
            vals_r__ = context__.vals_r("alphatime");
            pos__ = 0;
            size_t alphatime_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < alphatime_j_1_max__; ++j_1__) {
                alphatime(j_1__) = vals_r__[pos__++];
            }
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(llik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            -(stan::math::log1p(pow(((get_base1(rho, i, "rho", 1) * (stan::math::exp((-(get_base1(pred0, i, "pred0", 1)) - (get_base1(phi, i, "phi", 1) * (get_base1(xalpha_fixed, i, "xalpha_fixed", 1) + get_base1(get_base1(b, i, "b", 1), 1, "b", 2))))) * (1 - stan::math::exp(((-(get_base1(phi, i, "phi", 1)) * (get_base1(alphatime, i, "alphatime", 1) + get_base1(get_base1(b, i, "b", 1), 2, "b", 2))) * st))))) / (get_base1(phi, i, "phi", 1) * (get_base1(alphatime, i, "alphatime", 1) + get_base1(get_base1(b, i, "b", 1), 2, "b", 2)))), get_base1(kappa, i, "kappa", 1)))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_llogisticsurvrizsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_llogisticsurvrizsimple";
    }
...
typedef model_llogisticsurvrizsimple_namespace::model_llogisticsurvrizsimple stan_model;
#ifndef USING_R
