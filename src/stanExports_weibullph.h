...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(99, 97, "end", "model_weibullph");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(subtract(elt_multiply(status, add(add((stan::math::log(kappa) + (kappa * stan::math::log(rho))), multiply((kappa - 1), stan::math::log(st))), pred1)), multiply(multiply(multiply(elt_multiply(elt_multiply(multiply(to_matrix(stan::math::exp(add(multiply((kappa - 1), stan::math::log(nodes1)), multiply(phi, row_sums(elt_multiply(nodesr, row_expan0(b, qpoints, pstream__)), pstream__)))), m, qpoints, 0), weights), st), stan::math::exp(pred0)), kappa), pow(rho, kappa)), 0.5)));
