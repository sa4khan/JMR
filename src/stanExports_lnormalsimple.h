...
namespace model_lnormalsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lnormalsimple");
    reader.add_event(91, 89, "end", "model_lnormalsimple");
    return reader;
}
...
class model_lnormalsimple
  : public stan::model::model_base_crtp<model_lnormalsimple> {
private:
        int m;
        int n;
        int p1;
        ...
        double c1;
public:
    model_lnormalsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lnormalsimple_namespace::model_lnormalsimple";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lnormalsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lnormalsimple_namespace::model_lnormalsimple stan_model;
#ifndef USING_R
