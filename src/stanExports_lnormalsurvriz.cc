...
#include "stanExports_lnormalsurvriz.h"

RCPP_MODULE(stan_fit4lnormalsurvriz_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lnormalsurvriz")
