...
#include "stanExports_lnormalsurvrizsimple.h"

RCPP_MODULE(stan_fit4lnormalsurvrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lnormalsurvrizsimple")
