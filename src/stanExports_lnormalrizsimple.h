...
namespace model_lnormalrizsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lnormalrizsimple");
    reader.add_event(100, 98, "end", "model_lnormalrizsimple");
    return reader;
}
...
class model_lnormalrizsimple
  : public stan::model::model_base_crtp<model_lnormalrizsimple> {
private:
        int m;
        int n;
        int p1;
        ...
        double c1;
public:
    model_lnormalrizsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lnormalrizsimple_namespace::model_lnormalrizsimple";
        ...
        try {
            ...
            for (int i = 1; i <= m; ++i) {
                ...
                stan::model::assign(llik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (logical_eq(get_base1(status, i, "status", 1), 1) ? stan::math::promote_scalar<local_scalar_t__>((lognormal_log(get_base1(psi, i, "psi", 1), -(stan::math::log(rho)), (1 / kappa)) - get_base1(pred1, i, "pred1", 1))) : stan::math::promote_scalar<local_scalar_t__>(lognormal_ccdf_log(get_base1(psi, i, "psi", 1), -(stan::math::log(rho)), (1 / kappa))) ), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lnormalrizsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lnormalrizsimple_namespace::model_lnormalrizsimple stan_model;
#ifndef USING_R
