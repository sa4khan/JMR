...
#include "stanExports_eweibullsurvrizsimple.h"

RCPP_MODULE(stan_fit4eweibullsurvrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_eweibullsurvrizsimple")
