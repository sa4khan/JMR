...
#include "stanExports_llogisticsurvriz.h"

RCPP_MODULE(stan_fit4llogisticsurvriz_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_llogisticsurvriz")
