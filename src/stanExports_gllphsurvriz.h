...
namespace model_gllphsurvriz_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gllphsurvriz");
    reader.add_event(54, 52, "end", "model_gllphsurvriz");
    return reader;
}
...
class model_gllphsurvriz
  : public stan::model::model_base_crtp<model_gllphsurvriz> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_gllphsurvriz(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gllphsurvriz_namespace::model_gllphsurvriz";
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(llik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (((((-(multiply(weights, stan::math::exp(add(subtract(multiply((get_base1(kappa, i, "kappa", 1) - 1), stan::math::log(nodes0)), stan::math::log1p(vpow(multiply(get_base1(gam, i, "gam", 1), nodes0), get_base1(kappa, i, "kappa", 1), pstream__))), multiply(get_base1(phi, i, "phi", 1), add(get_base1(xalpha1, i, "xalpha1", 1), multiply(nodes, get_base1(b, i, "b", 1)))))))) * st) * get_base1(kappa, i, "kappa", 1)) * pow(get_base1(rho, i, "rho", 1), get_base1(kappa, i, "kappa", 1))) * stan::math::exp(get_base1(pred0, i, "pred0", 1))) * 0.5), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gllphsurvriz_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_gllphsurvriz_namespace::model_gllphsurvriz stan_model;
#ifndef USING_R
