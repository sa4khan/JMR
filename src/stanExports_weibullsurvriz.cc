...
#include "stanExports_weibullsurvriz.h"

RCPP_MODULE(stan_fit4weibullsurvriz_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_weibullsurvriz")
