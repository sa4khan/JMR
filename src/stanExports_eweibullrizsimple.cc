...
#include "stanExports_eweibullrizsimple.h"

RCPP_MODULE(stan_fit4eweibullrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_eweibullrizsimple")
