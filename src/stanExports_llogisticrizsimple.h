...
namespace model_llogisticrizsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_llogisticrizsimple");
    reader.add_event(102, 100, "end", "model_llogisticrizsimple");
    return reader;
}
...
class model_llogisticrizsimple
  : public stan::model::model_base_crtp<model_llogisticrizsimple> {
private:
        int m;
        int n;
        int p1;
        ...
        double c1;
public:
    model_llogisticrizsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_llogisticrizsimple_namespace::model_llogisticrizsimple";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(subtract(elt_multiply(status, subtract(add((stan::math::log(kappa) + (kappa * stan::math::log(rho))), multiply((kappa - 1), stan::math::log(psi))), pred1)), elt_multiply(add(1, status), stan::math::log1p(vpow(multiply(rho, psi), kappa, pstream__)))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_llogisticrizsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_llogisticrizsimple";
    }
...
typedef model_llogisticrizsimple_namespace::model_llogisticrizsimple stan_model;
#ifndef USING_R
