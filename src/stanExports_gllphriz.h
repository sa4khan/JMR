...
namespace model_gllphriz_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gllphriz");
    reader.add_event(114, 112, "end", "model_gllphriz");
    return reader;
}
...
class model_gllphriz
  : public stan::model::model_base_crtp<model_gllphriz> {
private:
        int m;
        int n;
        int p1;
        ...
        double d1;
public:
    model_gllphriz(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gllphriz_namespace::model_gllphriz";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 74;
        if (!(context__.contains_r("inv_gam2")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable inv_gam2 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("inv_gam2");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "inv_gam2", "double", context__.to_vec());
        double inv_gam2(0);
        inv_gam2 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, inv_gam2);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable inv_gam2: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 75;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 74;
            local_scalar_t__ inv_gam2;
            (void) inv_gam2;  // dummy to suppress unused var warning
            if (jacobian__)
                inv_gam2 = in__.scalar_lb_constrain(0, lp__);
            else
                inv_gam2 = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 75;
            ...
            stan::math::assign(gam, inv_sqrt(inv_gam2));
            ...
            lp_accum__.add(subtract(elt_multiply(status, add(subtract(add((stan::math::log(kappa) + (kappa * stan::math::log(rho))), multiply((kappa - 1), stan::math::log(st))), stan::math::log1p(vpow(multiply(gam, st), kappa, pstream__))), pred1)), multiply(multiply(multiply(elt_multiply(elt_multiply(multiply(to_matrix(stan::math::exp(add(subtract(multiply((kappa - 1), stan::math::log(nodes1)), stan::math::log1p(vpow(multiply(gam, nodes1), kappa, pstream__))), multiply(phi, add(multiply(nodesf, alpha), row_sums(elt_multiply(nodesr, row_expan0(b, qpoints, pstream__)), pstream__))))), m, qpoints, 0), weights), st), stan::math::exp(pred0)), kappa), pow(rho, kappa)), 0.5)));
            ...
            lp_accum__.add(gamma_log(inv_gam2, d0, d1));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gllphriz_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double inv_gam2 = in__.scalar_lb_constrain(0);
        vars__.push_back(inv_gam2);
...
typedef model_gllphriz_namespace::model_gllphriz stan_model;
#ifndef USING_R
