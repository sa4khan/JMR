...
namespace model_eweibullrizsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_eweibullrizsimple");
    reader.add_event(113, 111, "end", "model_eweibullrizsimple");
    return reader;
}
...
class model_eweibullrizsimple
  : public stan::model::model_base_crtp<model_eweibullrizsimple> {
private:
        int m;
        int n;
        int p1;
        ...
        double d1;
public:
    model_eweibullrizsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_eweibullrizsimple_namespace::model_eweibullrizsimple";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "d0", "double", context__.to_vec());
            d0 = double(0);
            vals_r__ = context__.vals_r("d0");
            pos__ = 0;
            d0 = vals_r__[pos__++];
            check_greater_or_equal(function__, "d0", d0, 0);
            current_statement_begin__ = 51;
            context__.validate_dims("data initialization", "d1", "double", context__.to_vec());
            d1 = double(0);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 57;
        if (!(context__.contains_r("squ_gam")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable squ_gam missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("squ_gam");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "squ_gam", "double", context__.to_vec());
        double squ_gam(0);
        squ_gam = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, squ_gam);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable squ_gam: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 58;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 57;
            local_scalar_t__ squ_gam;
            (void) squ_gam;  // dummy to suppress unused var warning
            if (jacobian__)
                squ_gam = in__.scalar_lb_constrain(0, lp__);
            else
                squ_gam = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 58;
            ...
            stan::math::assign(gam, stan::math::sqrt(squ_gam));
            ...
            current_statement_begin__ = 68;
            if (stan::math::is_uninitialized(gam)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: gam";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable gam: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            ...
            validate_non_negative_index("llik", "m", m);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> llik(m);
            ...
            for (int i = 1; i <= m; ++i) {
                ...
                if (as_bool(get_base1(status, i, "status", 1))) {
                    current_statement_begin__ = 92;
                    stan::model::assign(llik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                ((((((stan::math::log(kappa) + stan::math::log(gam)) + (kappa * stan::math::log(rho))) + ((kappa - 1) * stan::math::log(get_base1(psi, i, "psi", 1)))) + ((gam - 1) * log1m_exp(-(pow((rho * get_base1(psi, i, "psi", 1)), kappa))))) - pow((rho * get_base1(psi, i, "psi", 1)), kappa)) - get_base1(pred1, i, "pred1", 1)), 
                                "assigning variable llik");
                } else {
                    current_statement_begin__ = 96;
                    stan::math::assign(logs0, log1m(stan::math::exp((gam * log1m_exp(-(pow((rho * get_base1(psi, i, "psi", 1)), kappa)))))));
                    current_statement_begin__ = 97;
                    stan::model::assign(llik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (is_inf(logs0) ? stan::math::promote_scalar<local_scalar_t__>((stan::math::log(gam) - pow((rho * get_base1(psi, i, "psi", 1)), kappa))) : stan::math::promote_scalar<local_scalar_t__>(logs0) ), 
                                "assigning variable llik");
                }
            }
            ...
            lp_accum__.add(gamma_log(squ_gam, d0, d1));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_eweibullrizsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double squ_gam = in__.scalar_lb_constrain(0);
        vars__.push_back(squ_gam);
    ...
    std::string model_name() const {
        return "model_eweibullrizsimple";
    }
...
typedef model_eweibullrizsimple_namespace::model_eweibullrizsimple stan_model;
#ifndef USING_R
