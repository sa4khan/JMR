...
namespace model_ggammasurvrizsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ggammasurvrizsimple");
    reader.add_event(45, 43, "end", "model_ggammasurvrizsimple");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ggammasurvrizsimple
  : public stan::model::model_base_crtp<model_ggammasurvrizsimple> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_ggammasurvrizsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ggammasurvrizsimple_namespace::model_ggammasurvrizsimple";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ggammasurvrizsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_ggammasurvrizsimple";
    }
...
typedef model_ggammasurvrizsimple_namespace::model_ggammasurvrizsimple stan_model;
#ifndef USING_R
