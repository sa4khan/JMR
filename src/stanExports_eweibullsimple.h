...
namespace model_eweibullsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_eweibullsimple");
    reader.add_event(104, 102, "end", "model_eweibullsimple");
    return reader;
}
...
class model_eweibullsimple
  : public stan::model::model_base_crtp<model_eweibullsimple> {
private:
        int m;
        int n;
        int p1;
        ...
        double d1;
public:
    model_eweibullsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_eweibullsimple_namespace::model_eweibullsimple";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_eweibullsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_eweibullsimple_namespace::model_eweibullsimple stan_model;
#ifndef USING_R
