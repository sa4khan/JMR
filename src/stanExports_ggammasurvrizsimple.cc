...
#include "stanExports_ggammasurvrizsimple.h"

RCPP_MODULE(stan_fit4ggammasurvrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ggammasurvrizsimple")
