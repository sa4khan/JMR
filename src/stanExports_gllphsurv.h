...
namespace model_gllphsurv_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gllphsurv");
    reader.add_event(53, 51, "end", "model_gllphsurv");
    return reader;
}
...
class model_gllphsurv
  : public stan::model::model_base_crtp<model_gllphsurv> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_gllphsurv(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gllphsurv_namespace::model_gllphsurv";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gllphsurv_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_gllphsurv_namespace::model_gllphsurv stan_model;
#ifndef USING_R
