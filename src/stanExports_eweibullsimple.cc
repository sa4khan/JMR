...
#include "stanExports_eweibullsimple.h"

RCPP_MODULE(stan_fit4eweibullsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_eweibullsimple")
