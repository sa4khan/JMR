...
#include "stanExports_weibullsurvrizsimple.h"

RCPP_MODULE(stan_fit4weibullsurvrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_weibullsurvrizsimple")
