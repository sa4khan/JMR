...
namespace model_weibullsurvrizsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_weibullsurvrizsimple");
    reader.add_event(42, 40, "end", "model_weibullsurvrizsimple");
    return reader;
}
#include <stan_meta_header.hpp>
class model_weibullsurvrizsimple
  : public stan::model::model_base_crtp<model_weibullsurvrizsimple> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_weibullsurvrizsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_weibullsurvrizsimple_namespace::model_weibullsurvrizsimple";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_weibullsurvrizsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_weibullsurvrizsimple";
    }
...
typedef model_weibullsurvrizsimple_namespace::model_weibullsurvrizsimple stan_model;
#ifndef USING_R
