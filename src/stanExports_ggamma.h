...
namespace model_ggamma_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ggamma");
    reader.add_event(111, 109, "end", "model_ggamma");
    return reader;
}
...
class model_ggamma
  : public stan::model::model_base_crtp<model_ggamma> {
private:
        int m;
        int n;
        int p1;
        ...
        double d1;
public:
    model_ggamma(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ggamma_namespace::model_ggamma";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ggamma_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_ggamma_namespace::model_ggamma stan_model;
#ifndef USING_R
