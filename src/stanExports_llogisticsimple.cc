...
#include "stanExports_llogisticsimple.h"

RCPP_MODULE(stan_fit4llogisticsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_llogisticsimple")
