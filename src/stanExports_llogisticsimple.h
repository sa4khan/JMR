...
namespace model_llogisticsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_llogisticsimple");
    reader.add_event(93, 91, "end", "model_llogisticsimple");
    return reader;
}
...
class model_llogisticsimple
  : public stan::model::model_base_crtp<model_llogisticsimple> {
private:
        int m;
        int n;
        int p1;
        ...
        double c1;
public:
    model_llogisticsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_llogisticsimple_namespace::model_llogisticsimple";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_llogisticsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_llogisticsimple_namespace::model_llogisticsimple stan_model;
#ifndef USING_R
