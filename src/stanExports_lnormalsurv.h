...
namespace model_lnormalsurv_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lnormalsurv");
    reader.add_event(43, 41, "end", "model_lnormalsurv");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lnormalsurv
  : public stan::model::model_base_crtp<model_lnormalsurv> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_lnormalsurv(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lnormalsurv_namespace::model_lnormalsurv";
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(llik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            lognormal_ccdf_log((((multiply(weights, stan::math::exp(multiply(-(get_base1(phi, i, "phi", 1)), multiply(nodes, get_base1(b, i, "b", 1))))) * st) * stan::math::exp(-(get_base1(pred0, i, "pred0", 1)))) * 0.5), -(stan::math::log(get_base1(rho, i, "rho", 1))), (1 / get_base1(kappa, i, "kappa", 1))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lnormalsurv_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lnormalsurv_namespace::model_lnormalsurv stan_model;
#ifndef USING_R
