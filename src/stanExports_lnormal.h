...
namespace model_lnormal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lnormal");
    reader.add_event(104, 102, "end", "model_lnormal");
    return reader;
}
...
class model_lnormal
  : public stan::model::model_base_crtp<model_lnormal> {
private:
        int m;
        int n;
        int p1;
        ...
        double c1;
public:
    model_lnormal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lnormal_namespace::model_lnormal";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lnormal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lnormal_namespace::model_lnormal stan_model;
#ifndef USING_R
