...
#include "stanExports_llogisticsurvsimple.h"

RCPP_MODULE(stan_fit4llogisticsurvsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_llogisticsurvsimple")
