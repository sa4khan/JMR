...
namespace model_eweibullsurvsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_eweibullsurvsimple");
    reader.add_event(45, 43, "end", "model_eweibullsurvsimple");
    return reader;
}
#include <stan_meta_header.hpp>
class model_eweibullsurvsimple
  : public stan::model::model_base_crtp<model_eweibullsurvsimple> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_eweibullsurvsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_eweibullsurvsimple_namespace::model_eweibullsurvsimple";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(psi, ((stan::math::exp((-(get_base1(pred0, i, "pred0", 1)) - (get_base1(phi, i, "phi", 1) * get_base1(get_base1(b, i, "b", 1), 1, "b", 2)))) * (1 - stan::math::exp(((-(get_base1(phi, i, "phi", 1)) * get_base1(get_base1(b, i, "b", 1), 2, "b", 2)) * st)))) / (get_base1(phi, i, "phi", 1) * get_base1(get_base1(b, i, "b", 1), 2, "b", 2))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_eweibullsurvsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_eweibullsurvsimple";
    }
...
typedef model_eweibullsurvsimple_namespace::model_eweibullsurvsimple stan_model;
#ifndef USING_R
