...
#include "stanExports_llogisticsurvrizsimple.h"

RCPP_MODULE(stan_fit4llogisticsurvrizsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_llogisticsurvrizsimple")
