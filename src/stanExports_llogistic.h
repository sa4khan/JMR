...
namespace model_llogistic_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_llogistic");
    reader.add_event(106, 104, "end", "model_llogistic");
    return reader;
}
...
class model_llogistic
  : public stan::model::model_base_crtp<model_llogistic> {
private:
        int m;
        int n;
        int p1;
        ...
        double c1;
public:
    model_llogistic(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_llogistic_namespace::model_llogistic";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_llogistic_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_llogistic_namespace::model_llogistic stan_model;
#ifndef USING_R
