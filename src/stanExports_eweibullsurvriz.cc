...
#include "stanExports_eweibullsurvriz.h"

RCPP_MODULE(stan_fit4eweibullsurvriz_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_eweibullsurvriz")
