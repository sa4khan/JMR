...
#include "stanExports_weibullsurvsimple.h"

RCPP_MODULE(stan_fit4weibullsurvsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_weibullsurvsimple")
