...
namespace model_ggammasimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ggammasimple");
    reader.add_event(99, 97, "end", "model_ggammasimple");
    return reader;
}
...
class model_ggammasimple
  : public stan::model::model_base_crtp<model_ggammasimple> {
private:
        int m;
        int n;
        int p1;
        ...
        double d1;
public:
    model_ggammasimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ggammasimple_namespace::model_ggammasimple";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ggammasimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_ggammasimple_namespace::model_ggammasimple stan_model;
#ifndef USING_R
