...
#include "stanExports_eweibullsurvsimple.h"

RCPP_MODULE(stan_fit4eweibullsurvsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_eweibullsurvsimple")
