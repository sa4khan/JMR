...
#include "stanExports_lnormalsurvsimple.h"

RCPP_MODULE(stan_fit4lnormalsurvsimple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lnormalsurvsimple")
