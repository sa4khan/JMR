...
#include "stanExports_weibullphsurvriz.h"

RCPP_MODULE(stan_fit4weibullphsurvriz_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_weibullphsurvriz")
