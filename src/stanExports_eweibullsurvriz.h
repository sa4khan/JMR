...
namespace model_eweibullsurvriz_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_eweibullsurvriz");
    reader.add_event(48, 46, "end", "model_eweibullsurvriz");
    return reader;
}
#include <stan_meta_header.hpp>
class model_eweibullsurvriz
  : public stan::model::model_base_crtp<model_eweibullsurvriz> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_eweibullsurvriz(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_eweibullsurvriz_namespace::model_eweibullsurvriz";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(psi, (((multiply(weights, stan::math::exp(multiply(-(get_base1(phi, i, "phi", 1)), add(get_base1(xalpha1, i, "xalpha1", 1), multiply(nodes, get_base1(b, i, "b", 1)))))) * st) * stan::math::exp(-(get_base1(pred0, i, "pred0", 1)))) * 0.5));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_eweibullsurvriz_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_eweibullsurvriz_namespace::model_eweibullsurvriz stan_model;
#ifndef USING_R
