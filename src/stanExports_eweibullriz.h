...
namespace model_eweibullriz_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_eweibullriz");
    reader.add_event(119, 117, "end", "model_eweibullriz");
    return reader;
}
...
class model_eweibullriz
  : public stan::model::model_base_crtp<model_eweibullriz> {
private:
        int m;
        int n;
        int p1;
        ...
        double d1;
public:
    model_eweibullriz(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_eweibullriz_namespace::model_eweibullriz";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(psi, multiply(elt_multiply(elt_multiply(multiply(to_matrix(stan::math::exp(multiply(-(phi), add(multiply(nodesf, alpha), row_sums(elt_multiply(nodesr, row_expan0(b, qpoints, pstream__)), pstream__)))), m, qpoints, 0), weights), st), stan::math::exp(minus(pred0))), 0.5));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_eweibullriz_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_eweibullriz_namespace::model_eweibullriz stan_model;
#ifndef USING_R
