...
namespace model_ggammariz_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ggammariz");
    reader.add_event(113, 111, "end", "model_ggammariz");
    return reader;
}
...
class model_ggammariz
  : public stan::model::model_base_crtp<model_ggammariz> {
private:
        int m;
        int n;
        int p1;
        ...
        double d1;
public:
    model_ggammariz(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ggammariz_namespace::model_ggammariz";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ggammariz_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_ggammariz_namespace::model_ggammariz stan_model;
#ifndef USING_R
