...
namespace model_lnormalsurvsimple_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lnormalsurvsimple");
    reader.add_event(40, 38, "end", "model_lnormalsurvsimple");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lnormalsurvsimple
  : public stan::model::model_base_crtp<model_lnormalsurvsimple> {
private:
        int N;
        int ni;
        int pp1;
...
public:
    model_lnormalsurvsimple(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lnormalsurvsimple_namespace::model_lnormalsurvsimple";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lnormalsurvsimple_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_lnormalsurvsimple";
    }
...
typedef model_lnormalsurvsimple_namespace::model_lnormalsurvsimple stan_model;
#ifndef USING_R
